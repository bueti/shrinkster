...
A [timoni.sh](http://timoni.sh) module for deploying db to Kubernetes clusters.
...
```shell
timoni -n default apply db oci://<container-registry-url>
```
